...
import { Target, Eye, Heart, Award, Users, Shield, BookOpen, Monitor, Trophy, MapPin, Phone, Mail, ArrowRight } from 'lucide-react'
    ...
    <div className="public-page min-h-screen">
      ...
      <section className="bg-gradient-to-br from-green-700 to-green-900 text-white">
        <div className="max-w-7xl mx-auto px-4 py-20 text-center">
          <p className="uppercase tracking-widest text-green-200 text-sm font-bold mb-3">Since 1998 • Sango Ota, Ogun State</p>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">About Mannaplus Group of Schools</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <p className="flex items-center gap-2"><MapPin size={16} className="text-green-600" /> 34, Orisun Ibukun Avenue, Arinko Sango Ota, Ogun State</p>
              <p className="flex items-center gap-2"><Phone size={16} className="text-green-600" /> +234 342 872 28, +234 803 496 7499</p>
              <p className="flex items-center gap-2"><Mail size={16} className="text-green-600" /> mannapluscollege@school.com</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-md border-l-4 border-green-600 p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-lg bg-green-100 flex items-center justify-center"><Target className="text-green-700" size={20} /></div>
            ...
            <div className="bg-white rounded-xl shadow-md border-l-4 border-blue-600 p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center"><Eye className="text-blue-700" size={20} /></div>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-gray-600 text-center mb-10 max-w-2xl mx-auto">The pillars that shape every lesson, assembly and interaction at Mannaplus.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (
              <div key={i} className="rounded-xl border border-gray-200 p-6 text-center hover:shadow-md transition-shadow">
                <div className="w-12 h-12 mx-auto rounded-lg bg-green-100 flex items-center justify-center mb-4"><v.icon className="text-green-700" size={24} /></div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <p className="text-gray-600 text-center mb-10 max-w-2xl mx-auto">A complete education that prepares children for examinations — and for life.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {whyUs.map((w, i) => (
            <div key={i} className="bg-white rounded-xl shadow-md border border-gray-200 p-6 flex gap-4">
              <div className="w-11 h-11 shrink-0 rounded-lg bg-green-100 flex items-center justify-center"><w.icon className="text-green-700" size={22} /></div>
              <div>
